            ...
            <div class="container">
                <div class="row">
                      ...
                      <div  class="col-sm-12">
                        ...
                        <form action="signupb2cinsert.php" id="" class="form-login" method="post" enctype="multipart/form-data">
                            <div id="a1" >
                                <div class="col-md-12 hello-text-wrap">
                                    <span class="hello-text text-thin">Hello, welcome Create your Customer account</span>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if (isset($_GET['msg'])) 
                                            { ?>
                                    <label for="disabledSelect" style="color: red; float: right;"><?php echo $_GET['msg']; ?></label>
                                    <?php } ?>
                            ...
                            <label for="disabledSelect">Select Security Question <sup>*</sup></label>
                                    ...
                                    <select class="form-control selectpicker" name="sec_que_tbl" required>
