	...
	$user_typ=2;
     ...
     $qry1 = "SELECT * FROM user_tbl WHERE email='".$email."' ";
      ...
      if (mysqli_num_rows($rs1)>0) 
        {
        	   echo '<script> alert("THIS_EMAIL-ID_IS _ALLREADY_REGISTERtion")</script>';
	...
	if($rs)
	{
		$body="Name is : $fname $lname<br>
		  for conformation login <br><br>
		  	click on link<br>
		    <a href='http://localhost/Stationery_Hub/Stationery%20Shop/action_email.php?email=$email'>click Here</a>";
