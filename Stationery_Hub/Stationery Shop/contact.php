            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 text-left">
                        ...
                        <!-- Contact form -->
                        <form name="contact-form" method="post" action="feedback.php" class="contact-form" id="contact-form">
             <?php
             ...
             ?> 
                            <div class="outer required">
                                <div class="form-group af-inner">
                                    <label class="sr-only" for="disabledSelect">Name</label>
                                    <input
                                            type="text" name="name" id="name" placeholder="Name" value="<?php echo $row['fname'];?>  <?php  echo $row['lname']; ?>" size="30"
                            ...
                            <div class="outer required">
                                ...
                                <div class="form-group af-inner">
                                    ...
                                    <input
                                            type="text" name="email" id="email" placeholder="Email" value="<?php echo $row['email']; ?>" size="30"
                            ...
                            <div class="outer required">
                                <div class="form-group af-inner">
                                    <input type="submit" name="btn_sb" class="form-button form-button-submit btn btn-theme btn-theme-dark" id="submit_btn" value="Send message" />
                                </div>
                            </div>
