...
if(isset($_POST['btn_sb']))
{
	...
	$user_typ=2;
     ...
     $qry1 = "SELECT * FROM user_tbl WHERE user_typ=1 AND email='".$email."' ";
      $rs1 = mysqli_query($conn,$qry1);
      if (mysqli_num_rows($rs1)>0) 
        {
        	           echo '<script> alert("THIS EMAIL-ID IS ALLREADY REGISTER")</script>';
	...
	if($rs)
	{
		$body="Name is : $fname $lname<br>
		  for conformation login <br><br>
		  	click on link<br>
		    <a href='http://localhost/Stationery_Hub/admin/action_email.php?email=$email'>click Here</a>";
	     ...
	     $mail->Body    = $bodyContent;
          ...
          'ssl' => array(
	        ...
	        if(!$mail->send()) {
	         ...
	         {
	         	  echo '<script> alert("Plz Check Our Email And Activate your Account ")</script>';
