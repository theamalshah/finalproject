        ...
        <tbody>
          ...
          <tr data-expanded="true">
                                ...
                                <td><?php echo $row['doi']; ?></td>
                                 ...
                                 <td><a href="action_user.php?id=<?php echo $row['user_id']; ?>&
                                      status=<?php echo $row['is_active']; ?>">Change</a></td>

                                <td><a href="delete_user.php?user_id=<?php echo $row['user_id']; ?>"><span class="glyphicon glyphicon-trash" style="color: red;"></a></td>
          </tr> 
